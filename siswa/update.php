<?php
    ...
    $sql = "UPDATE siswa SET nama_siswa='$nama', jk_siswa='$jk', alamat_siswa='$alamat', kd_kelas='$kdkelas' WHERE nis='$nis' ";
    ...
    if($conn->affected_rows>0){
        header("location:../index.php?menu=siswa&flag=sukses update");
    }else{
        header("location:../index.php?menu=siswa&flag=data tidak berubah");
    }
