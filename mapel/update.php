<?php 
    ...
    $sql = "UPDATE mapel SET nama_mapel='$namamapel', jp='$jp' ,kd_guru='$kdguru' WHERE kd_mapel='$kdmapel' ";
    ...
    if($conn->affected_rows>0){
        header("location:../index.php?menu=mapel&flag=sukses update");
    }else{
        header("location:../index.php?menu=mapel&flag=data tidak berubah");
    }
